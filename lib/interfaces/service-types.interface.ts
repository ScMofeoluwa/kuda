export enum serviceTypeEnums {
  ...
  CREATE_FIXED_SAVINGS = "CREATE_FIXED_SAVINGS",
  GET_FIXED_SAVINGS = "GET_FIXED_SAVINGS",
  GET_ALL_CUSTOMER_FIXED_SAVINGS = "GET_ALL_CUSTOMER_FIXED_SAVINGS",
  COMPLETE_FIXED_SAVINGS_WITHDRAWAL = "COMPLETE_FIXED_SAVINGS_WITHDRAWAL",
  RETRIEVE_FIXED_SAVINGS_TRANSACTIONS = "RETRIEVE_FIXED_SAVINGS_TRANSACTIONS",
}
